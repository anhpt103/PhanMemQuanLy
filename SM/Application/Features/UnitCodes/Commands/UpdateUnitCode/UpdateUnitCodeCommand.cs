...
{
    public class UpdateUnitCodeCommand : IRequest<Response<string>>
    {
        ...
        public class UpdateUnitCodeCommandHandler : IRequestHandler<UpdateUnitCodeCommand, Response<string>>
        {
            ...
            public async Task<Response<string>> Handle(UpdateUnitCodeCommand command, CancellationToken cancellationToken)
            {
